...
select b.username, a.executions Total_Execs, c.ExecPerSecs "Latency(ms)",  disk_reads,a.hash_value, c.address, a.sql_text
...
and b.username not in ('SYS', 'SYSTEM', 'PATROL', 'PERFSTAT', 'OPS$ORACLE')
