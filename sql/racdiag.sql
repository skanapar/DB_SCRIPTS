...
-- commeted by EA --oraebug setmypid
-- commeted by EA --oradebug unlimit
-- commeted by EA --oradebug -g all hanganalyze 3
-- commeted by EA --alter session set events '10998 trace name context forever, level 256';
-- This part may take the longest, you can monitor bdump or udump to see if the
-- file is being generated.
-- commeted by EA --oradebug -g all dump systemstate 10
...
-- Taking Hang Analyze dumps
-- This may take a little while...
-- commeted by EA --oradebug setmypid
-- commeted by EA --oradebug unlimit
-- commeted by EA --oradebug -g all hanganalyze 3
-- commeted by EA --alter session set events '10998 trace name context forever, level 256';
-- This part may take the longest, you can monitor bdump or udump to see if the
