...
SPO OFF;
-- cleanup
HOS zip -m sqlmon_&&sql_id. sqlmon_&&sql_id._*.html
HOS zip sqlmon_&&sql_id. sqlmon_&&sql_id..txt
HOS zip -m sqlmon_&&sql_id. sqlmon_&&sql_id._driver.sql
HOS zip -d sqlmon_&&sql_id. sqlmon_&&sql_id._driver.sql
PRO sqlmon_&&sql_id..zip contains text and active reports
PRO sqlmon_&&sql_id..txt is the text report
