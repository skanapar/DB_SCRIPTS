...
# Version 1.0
# Modified: 5-Sep-2019
#Purpose:  Runs a sql script on all  PeopleSoft instances of this nodes excluding ASM and MGMT DB
...
#        echo $ORACLE_SID
PDBS=`${BIN_DIR}/get_psoft_pdbs.sh|grep -v "^#"|grep -v SEED| egrep 'FIN*|PAY*|PHR*'`
