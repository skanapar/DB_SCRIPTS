...
BEGIN
 ...
 -- USERS_T := USER_TYPE_T('DEV_IAU','DEV_IAU_APPEND','DEV_IAU_VIEWER','DEV_MDS','DEV_OPSS','DEV_SOAINFRA', 'DEV_STB','DEV_UMS','DEV_WLS','DEV_WLS_RUNTIME');
  USERS_T := USER_TYPE_T ('PRD_OPSS', 'PRD_UMS', 'PRD_IAU_VIEWER', 'PRD_IAU_APPEND', 'PRD_IAU', 'PRD_MDS', 'PRD_SOAINFRA', 'PRD_STB', 'PRD_WLS_RUNTIME', 'PRD_WLS');
